...
>
> 基线版本：
> - 轨道 A QMT 模拟盘 `track_a/TrackA_track_a_qmt_full_chain_sim_v2.46.py` **v2.46（Fix C 成交确认）**
...
| 角色 | 轨道 A | 轨道 B |
|------|--------|--------|
| QMT 模拟盘 | `track_a/TrackA_track_a_qmt_full_chain_sim_v2.46.py` | `track_b/TrackB_track_b_qmt_auction_sim_v2.14.py` |
