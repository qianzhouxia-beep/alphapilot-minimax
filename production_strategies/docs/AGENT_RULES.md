...
| 轨道 | 文件 | 平台 | 备注 |
|------|------|------|------|
| A | `track_a/TrackA_track_a_qmt_full_chain_sim_v2.46.py` | QMT 模拟盘 | v2.46，Fix C 成交确认（VERIFY_FILL） |
...
| B | `track_b/TrackB_track_b_qmt_auction_sim_v2.14.py` | QMT 模拟盘（第二账户） | v1.0，已修 F1/F2 |
