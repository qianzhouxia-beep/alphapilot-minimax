# coding:utf-8
# AlphaPilot -- Track B QMT LIVE strategy TEMPLATE v2.7-tpl (vwap 2nd confirm)
# =========================================================
# v2.7-tpl (2026-09-02): vwap_weak_early needs TWO still-below minutes.
# First 09:35-09:50 tick below vwap_ref only arms; a later minute still
# below sells. Recover (>=vwap_ref) still cancels. Same as Track A v2.30.
...
def init(C):
    ...
    print("[INIT] track-B v2.7-tpl (auction-select, vwap 2nd) | acct=" +
...
# 5) Check the log prints "[INIT] track-B v2.7-tpl ... acct=<ACCOUNT_ID>".
#
