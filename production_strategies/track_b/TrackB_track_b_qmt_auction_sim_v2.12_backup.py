...
# (BACKUP COPY -- NOT a deployment target; QMT loads TrackB_track_b_qmt_auction_sim_v2.14.py)
...
# Key differences vs Track A (TrackA_track_a_qmt_full_chain_sim_v2.46.py):
