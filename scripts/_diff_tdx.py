...
tdx = Path(r"D:\new_tdx_mock\PYPlugins\user\TrackA_track_a_tdx_full_chain_sim.py").read_text(encoding="utf-8", errors="replace")
local = Path(r"C:\Users\elvisq\Projects\alphapilot\production_strategies\track_a\TrackA_track_a_tdx_full_chain_sim.py").read_text(encoding="utf-8", errors="replace")
