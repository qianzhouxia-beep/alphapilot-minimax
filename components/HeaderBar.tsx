  ...
  return (
    <header className="mb-4 sm:mb-6 flex flex-wrap items-center justify-between gap-3">
      <Link href="/" className="flex items-center gap-3">
        <Image src="/logo.svg" alt="AlphaPilot" className="h-10 w-auto" width={120} height={40} priority />
      ...
      <div className="flex flex-wrap items-center gap-2 sm:gap-3">
        {/* Navigation */}
        <div className="flex items-center gap-1 rounded-lg border border-border-subtle/50 bg-surface-card p-0.5">
          <Link
            href="/cn"
            className="rounded-md px-2.5 py-1.5 text-[11px] text-text-secondary hover:text-text-primary hover:bg-[rgba(77,163,255,0.1)] transition-colors"
          >
            Dashboard
          </Link>
          <Link
            href="/cn/watchlist"
            className="rounded-md px-2.5 py-1.5 text-[11px] text-[#F5C451] hover:text-text-primary hover:bg-[rgba(245,196,81,0.15)] transition-colors flex items-center gap-1"
          >
          ...
          <Link
            ...
            className="rounded-md px-2.5 py-1.5 text-[11px] text-status-info hover:text-text-primary hover:bg-[rgba(139,92,246,0.15)] transition-colors flex items-center gap-1"
          >
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <rect x="2" y="3" width="20" height="14" rx="2" ry="2" /><line x1="8" y1="21" x2="16" y2="21" /><line x1="12" y1="17" x2="12" y2="21" />
            </svg>
            量化模拟盘
            <span className="text-[8px] px-1 py-0.5 rounded-sm bg-[rgba(139,92,246,0.15)] text-status-info font-medium">量化</span>
          </Link>
          <Link
            href="/cn/chat"
            className="rounded-md px-2.5 py-1.5 text-[11px] text-text-secondary hover:text-text-primary hover:bg-[rgba(77,163,255,0.1)] transition-colors"
