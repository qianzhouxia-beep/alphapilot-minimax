...
function WatchlistTable({ items, onRemove, removing, onRetrack, retracking, onPriceClick }: {
  ...
  return (
    <div className="overflow-x-auto -mx-4 sm:mx-0">
      {/* Header */}
      <div className="grid grid-cols-[2fr_1.2fr_1fr_1fr_0.8fr_0.8fr_0.8fr_0.8fr_0.8fr_0.8fr] gap-0 text-[11px] uppercase tracking-wider text-text-disabled border-b border-border-subtle">
  ...
  return (
    <div className="overflow-x-auto -mx-4 sm:mx-0">
      ...
      {mergedRows.map((row) => {
            ...
            return (
            <div key={row.symbol} className="grid grid-cols-[2fr_1.2fr_1fr_1fr_0.8fr_0.8fr_0.8fr_0.8fr_0.8fr_0.8fr] gap-0 text-[13px] border-b border-border-subtle/30 hover:bg-primary/4 transition-colors">
              <div className="px-2 py-3 flex items-center gap-2">
                <div>
